...
{
    /// <summary>
    /// Логика взаимодействия для ActiveApplicationsWindow.xaml
    /// </summary>
    public partial class ActiveApplicationsWindow : Window
    {
        ...
        private async Task LoadApplicationsAsync()
        {
            try
            {
                ...
                applications = await apiService.GetActiveApplicationsAsync();
                if (applications.Count > 0)
                {
                    UpdateApplicationDisplay();
                    UpdateApplicationCounter();
        ...
        private UIElement CreateApplicationUI(ApplicationResponse application)
        {
            ...
            void AddRow(string label, UIElement element, bool isLeftColumn)
            {
                ...
                if (element is TextBlock textBlock)
                {
                    ...
                    textBlock.MaxWidth = shouldWrap ? 500 : double.PositiveInfinity;
                }
